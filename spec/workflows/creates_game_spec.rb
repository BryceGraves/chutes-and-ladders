  ...
  describe "Game Creation Failure" do
    context "When a game is made with a blank name" do
      it "It returns an error" do
        expect { bad_game_creator_blank_name.create }.to raise_error("Validation failed: Name can't be blank")
      end
    end

    context "When a game is made with a nil name" do
      it "It returns an error" do
        expect { bad_game_creator_nil_name.create }.to raise_error("Validation failed: Name can't be blank")
      end
    end
  end
